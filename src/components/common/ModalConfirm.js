        ...
        <Dialog open={isOpen} onClose={onClose} className="relative z-10">
            ...
            <div className="fixed inset-0 z-10 flex items-center justify-center p-4 sm:p-0">
                <motion.div
                    ...
                    className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl w-full max-w-sm sm:max-w-lg"
                >
                    <DialogPanel>
                        ...
                        <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 gap-2 flex flex-col-reverse">
                            <button
                                onClick={onClose}
                                className="inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 shadow-sm ring-gray-300 hover:bg-gray-50 sm:w-auto"
                            >
                                Hủy
                            </button>
                            <button
                                ...
                                ${confirmText === "Xác nhận" ? "bg-blue-600 hover:bg-blue-500" : "bg-red-600 hover:bg-red-500"}`}
                            >
                                {confirmText}
                            </button>
                        </div>
