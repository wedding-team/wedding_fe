...
const FeaturesSection = () => {
    const features = [
        {
            icon: <LuHeart className="w-10 h-10 text-pink-500"/>,
        ...
        {
            icon: <LuGift className="w-10 h-10 text-pink-500"/>,
        ...
        {
            icon: <LuMessageCircle className="w-10 h-10 text-pink-500"/>,
        ...
        {
            icon: <LuCloud className="w-10 h-10 text-pink-500"/>,
        ...
        {
            icon: <LuUserRoundCheck className="w-10 h-10 text-pink-500"/>,
        ...
        {
            icon: <LuPenTool className="w-10 h-10 text-pink-500"/>,
