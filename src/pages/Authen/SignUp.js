...
function SignUp() {
    ...
    return (
        <div className="relative flex overflow-hidden h-screen items-center justify-center bg-red-900 px-4">
            ...
            <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-4 sm:p-6 mx-2 sm:mx-0 mt-18 md:mt-24 z-50">
                <div className="flex justify-between items-center">
                    <div className="flex flex-col space-y-1">
                        <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Đăng ký tài khoản</h2>
                        <p className="text-xs sm:text-sm text-gray-600">Hãy điền đầy đủ thông tin để tạo tài khoản mới.</p>
                    </div>
                ...
                <p className="mt-6 text-center text-sm text-gray-600">
                    ...
                    <Link to={"/login"} className="text-red-600 hover:text-red-700 font-medium hover:underline transition-colors duration-200">
                        Đăng nhập
                    </Link>
                </p>
            </div>
